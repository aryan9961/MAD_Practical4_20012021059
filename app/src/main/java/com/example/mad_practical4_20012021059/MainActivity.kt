...
import com.example.mad_practical4_20012021059.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.aboutUsBtn.setOnClickListener {
            ...
            val next = Intent(this,MyActivity::class.java)
            intent.putExtra("massage_key",message)
